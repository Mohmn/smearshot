// use notify::{recommended_watcher, RecursiveMode, Watcher, Error};
// use std::path::Path;

// pub fn watch(path: String) -> Result<(), Error> {
// 	println!("path selected for watch {:?}", path);
// 	let mut watcher = recommended_watcher(move |res| {
// 		// println!("event: {:?}", res);
// 			match res {
// 				 Ok(event) => {
// 						 println!("event: {:?}", event);
// 						 // Send an event to the frontend, you'll implement this later
// 				 },
